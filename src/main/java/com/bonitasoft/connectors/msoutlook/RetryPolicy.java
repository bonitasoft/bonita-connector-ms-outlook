...
/**
 * Retry policy with exponential backoff and jitter for Microsoft Graph API calls.
 */
@Slf4j
public class RetryPolicy {
     ...
     */
    public <T> T execute(Callable<T> action) throws MsOutlookException {
        int attempt = 0;
        while (true) {
            try {
                return action.call();
                ...
                throw new MsOutlookException("Unexpected error during API call", e);
            }
        }
    }
